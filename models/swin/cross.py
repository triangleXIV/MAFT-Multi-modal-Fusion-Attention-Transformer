...
config_file = os.path.join('./bert_config.json')
bert_config = BertConfig.from_json_file(config_file)
cross1 = BertCrossEncoder(bert_config)#这一段写在init里
feature_a=torch.Tensor(4, 32, 768)
feature_b=torch.Tensor(4, 49, 768)
extended_s2_mask=torch.Tensor(4, 1, 1, 49)
img_cross_encoder = cross1(feature_a, feature_b, extended_s2_mask)#这一段在forward里
print(img_cross_encoder)
